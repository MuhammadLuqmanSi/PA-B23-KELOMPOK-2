        ...
        while True:
            ...
            if pilihan == "1":
                ...
                if result_index != -1:
                    print("Data ditemukan:")
                    x = PrettyTable()
                    x.field_names = ["ID", "Nama Pemukiman", "Jumlah Rumah", "Jumlah Penduduk", "Luas Wilayah", "ID ADMIN"]
                    x.add_row(data_list[result_index])
                    print(x)
                else:
                    print("Data tidak ditemukan.")
...
def tambah_data_proyek():
    try:
        ...
        query_check_pemukiman = "SELECT id_pemukiman FROM perkotaan WHERE id_pemukiman = {id_pemukiman}"
